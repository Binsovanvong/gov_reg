      ...
      builder: (ctx) => Dialog(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF0A2D66).withOpacity(0.18),
                blurRadius: 40,
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      "សូមពិនិត្យព័ត៌មានរបស់លោកអ្នកឱ្យបានត្រឹមត្រូវ មុននឹងដាក់ស្នើ។",
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Expanded(
                            child: Text(
                              "ព័ត៌មានដែលបានដាក់ស្នើរួចមិនអាចកែប្រែបានឡើយ។ សូមប្រាកដថាព័ត៌មានទាំងអស់ត្រឹមត្រូវមុននឹងបន្ត។",
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w600,
                                color: Color(0xFF0A2D66),
